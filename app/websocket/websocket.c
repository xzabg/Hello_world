...
#define local_host_name		"101.201.211.87"//"iot.espressif.cn"
#define local_host_url		"zfzn02/servlet/ElectricOrderServlet"  //"v1/datastreams/tem_hum/datapoint"
#define local_host_port		"9000"
#define local_host_ports	"8080"//"9443"
...
nopoll_bool test_02 (void) {
	...
	/* send content text(utf-8) */
	if (nopoll_conn_send_text (conn, "masterCode=AA00FF62", 19) != 19) {//"This is a test"
		printf ("ERROR: Expected to find proper send operation..\n");
		return nopoll_false;
	}
